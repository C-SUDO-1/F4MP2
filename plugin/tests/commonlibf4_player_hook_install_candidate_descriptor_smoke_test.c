...
int main(void) {
    ...
    cfg.site_candidate = clf4_phdsc_default();
    ...
    assert(stats.site_candidate_name != NULL);
    assert(strcmp(stats.site_candidate_name, "player_character_update_before_input") == 0);
